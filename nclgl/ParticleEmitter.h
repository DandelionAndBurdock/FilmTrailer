...
public:
	...
	*/
	...
	// Where do particles spawn from?
	glm::vec3	GetSpawnPoint() { return position; }
	void	SetSpawnPoint(glm::vec3 position) { this->position = position; }
	...
	*/
	void	SetDirection(const glm::vec3 dir) {initialDirection = dir;}
	glm::vec3 GetDirection()					{return initialDirection;}
